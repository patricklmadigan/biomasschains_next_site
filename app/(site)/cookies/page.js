  ...
  return (
    <article className="container py-16 prose prose-invert max-w-3xl">
      ...
      <p>
        ...
        aggregated analytics. If any non‑essential cookies are enabled, we will ask for your consent via a banner.
      </p>

      <h2>Types of cookies</h2>
      <ul>
        <li>
          <strong>Strictly necessary</strong> — required to operate the site and forms. These don’t require consent.
        </li>
        <li>
          <strong>Analytics (optional)</strong> — help us understand page usage. These are set only if you consent.
        </li>
      </ul>

      <h2>Managing your preferences</h2>
      <p>
        You can update your cookie choice at any time here. Resetting removes your saved preference so the site can ask
        again for consent if optional cookies are used in future.
      </p>
